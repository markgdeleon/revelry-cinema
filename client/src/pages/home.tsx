          ...
          <Link href={`/film/${film!.slug}`} key={film!.slug} className="block">
            ...
            >
              <img 
                src={film!.heroImage} 
                alt={film!.title}
                className="w-full h-auto md:absolute md:inset-0 md:w-full md:h-full md:object-cover md:object-[center_35%] md:scale-[1.35] transition-transform duration-700 group-hover:scale-[1.40]"
              />
