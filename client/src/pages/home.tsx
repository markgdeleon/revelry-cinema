              ...
              <Link href={`/film/${film!.slug}`} className="block absolute inset-0">
                <img 
                  ...
                  className={`absolute inset-0 w-full h-full object-cover scale-[1.35] ${
                    film!.slug === 'summer-jazz' ? 'object-[40%_35%]' : film!.slug === 'anita' ? 'object-[15%_35%]' : film!.slug === 'as-one' ? 'object-[54%_35%]' : film!.slug === 'the-master-chief' ? 'object-[46%_35%]' : 'object-[center_35%]'
                  }`}
                />
                {/* Gradient overlay */}
